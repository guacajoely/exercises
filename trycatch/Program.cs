class Program
{
    ...
    */
    ...
    static void Main(string[] args)
    {
        ...
        // ADD A TRY CATCH SO DUPLICATES DON'T RETURN AN ERROR
        try
        {
        ...
        {
            Console.WriteLine("duplicate contact could not be added. Key must be unique.");
        }
        ...
        // ADD A TRY CATCH FOR AN EMAIL NOT BEING FOUND IN THE ADDRESS BOOK
    ...
    public class AddressBook
    {
        ...
        {
            _contactList.Add(contactObject.Email, contactObject);
        }
